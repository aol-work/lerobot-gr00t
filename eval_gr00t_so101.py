...
class SO101Robot:
    ...
    def go_home(self):
        ...
        home_state = torch.tensor([0.0664, 156.7090, 135.6152, 83.7598, -89.1211, 16.5107])
...
class Gr00tRobotInferenceClient:
    def __init__(
        ...
        host="localhost",
        port=5555,
        language_instruction="Stand still and do nothing",
    ):
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--lang_instruction", type=str, default="Move the fruits into the blue plate"
    )
    ...
    if USE_POLICY:
        ...
        robot = SO101Robot(calibrate=False, enable_camera=True, cam_idx=args.cam_idx)
        image_count = 0
        with robot.activate():
